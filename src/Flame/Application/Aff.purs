--the default way to run a flame app
module Flame.Aff(Application, emptyApp, mount) where
...
type Application model message = App model message ( update :: World model message -> model -> message -> Aff model )
