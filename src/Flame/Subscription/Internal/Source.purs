...
createSubscription :: forall message. Source -> EventName -> message -> Subscription message
createSubscription source eventName message = DTN.tuple3 source eventName (const message)

createRawSubscription :: forall arg message. Source -> EventName -> (arg -> message) -> Subscription message
