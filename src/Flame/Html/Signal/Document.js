...
//in channelRawHandler and channelSpecialHandler since applyHandler is an Applicative we have to first receive the type class dictionary (hence the indirection layer)
