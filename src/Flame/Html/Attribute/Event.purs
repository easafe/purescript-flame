...
foreign import createEvent_ ∷ ∀ message. Fn2 EventName message (NodeData message)
foreign import createRawEvent_ ∷ ∀ message. Fn2 EventName (Event → Effect (Maybe message)) (NodeData message)
